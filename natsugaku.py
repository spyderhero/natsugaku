...
with col1:
    st.image("(sim1,2)Psi4.png", caption="図3.2: $\Psi_4$の球面調和関数展開 $l=2, m=2$のSim1 とSim2 の比較", use_container_width=True)
...
with col1:
    st.image("(sim1,2)GW-energy.png", caption="図4.1: 重力場のエネルギー放出率のSim1 とSim2 の比較", use_container_width=True)

with col2:
    st.image("(sim1,2) EM-energy.png", caption="図4.2: 電磁場のエネルギー放出率のSim1 とSim2 の比較", use_container_width=True)
